        ...
        <div className="md:flex md:items-start md:justify-between">
          <div className="mb-8 md:mb-0 md:w-1/3">
            ...
            <p className="text-muted-foreground mt-2 text-sm">
              Smart image sharing platform with advanced face recognition technology for instant photo retrieval.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 md:gap-16 md:w-2/3 md:grid-cols-3">
            <div>
              <h3 className="text-sm font-semibold text-foreground tracking-wider uppercase mb-4">Features</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-foreground text-sm">Face Recognition</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-foreground text-sm">Event Management</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-foreground text-sm">Secure Sharing</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-foreground text-sm">Photo Filtering</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-muted-foreground hover:text-foreground text-sm">GDPR Compliance</a></li>
              </ul>
            </div>
          </div>
        </div>
        
        <div className="mt-8 pt-8 border-t border-border md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-muted-foreground text-sm md:mt-0 md:order-1">
            &copy; {new Date().getFullYear()} FaceFind. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
